...
$ helm install ./helm --name sso --kubeconfig="helm/kubeconfig.yaml"

Or update if you want to update an existing one
$ helm upgrade sso  ./helm --kubeconfig="helm/kubeconfig.yaml" 

Or del if you want to delete an existing  one
$ helm del sso  --purge --kubeconfig="helm/kubeconfig.yaml" 
